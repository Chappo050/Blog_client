        ...
        react_1["default"].createElement(react_1["default"].Fragment, null,
            react_1["default"].createElement("div", { className: "grid grid-cols-5 " },
                ...
                react_1["default"].createElement("form", { onSubmit: handleSubmit, className: "text-custom-green-blue border border-custom-silver text-center col-span-3 " },
                    react_1["default"].createElement("div", { className: "text-lg pt-5" }, "Please Edit Your Post."),
                    react_1["default"].createElement("div", { className: "p-2 m-10" },
                        react_1["default"].createElement("textarea", { name: "message", "overflow-y": "hidden", value: formValue.message, onChange: handleChange, required: true, className: "text-black p-2 h-44 w-full bg-custom-aquamarine", maxLength: 750 }, " ")),
                    messagePosted ? react_1["default"].createElement(SuccessMessage, null) : null,
                    react_1["default"].createElement("div", { className: "p-2 m-2" },
                        react_1["default"].createElement("label", { className: "pr-2" }, "Public? "),
                        react_1["default"].createElement("input", { type: "checkbox", name: "isPublic", checked: formValue.isPublic, onChange: handleCheck })),
...
var SuccessMessage = function () {
    return (react_1["default"].createElement("div", { className: "text-custom-green-blue border-custom-silver text-2xl border-b-4 border-t-4  animate-pulse" }, "Message successfully updated!"));
};
